...
def generate_code_using_bedrock(message:str, language:str) -> str:
    ...
    prompt_text = f"""Human: Write {language} code for the following instrucitons: {message}. Also don't generate examples for this, just give me the code.
    Assistant:
    """
    body = {
        "prompt": prompt_text,
    ...
    try:
        ...
        response_data = json.loads(response_content) # deserialize into a python object from a json stream
...
def lambda_handler(event, contenxt):
    ...
    if generated_code:
        ...
        s3_bucket = 'bedrock-course-bucket-240920'
